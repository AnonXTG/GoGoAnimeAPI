...
### **Note** :- This is the original work of [Team Scenario](https://github.com/TeamScenario/GoGoAnimeAPI), we just cloned the API and made convenient for us to use this API. If you want to use this API try forking the original work.
